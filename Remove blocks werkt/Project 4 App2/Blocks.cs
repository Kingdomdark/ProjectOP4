...
namespace Project_4_App2
{
    ...
    class BlocksFactory
    {
        ...
        public IBlock Create(int id)
        {
            ...
            {
                Console.WriteLine("pointblock is drawn");
            ...
            {
                Console.WriteLine("bombblock is drawn");
    ...
    class PointBlock : IBlock
    {
        ...
        public void Update(GameTime gameTime, AndroidPlayer theplayer) //method to Update the game
        {
            position.X -= 15;
            ...
            //    {
            //        theplayer.SetScore();
            //        Console.WriteLine("the score is: " + theplayer.GetScore());
            //        gameLogic.RemoveBlock();
            //    }
        }
